...
const About: React.FC = () => (
  <div className='about section-header' id='about'>
    ...
    <div className='me'>
      ...
      <p> My favorite coding languages is probably Typescript, but I also enjoy writing code in Python and C#</p>
      ...
      <p>Outside of work, I like to be out on the water in my kayak, or out riding my bike.</p>
