...
const Projects: React.FC = () => (
  ...
  <div className='skills section-header' id='projects'>
    <h1>My Projects</h1>
    <div className='me'>
      <p>My work is proprietary, but you can see some applications that I have built for fun by visiting my <a href='https://github.com/christsantiris' target='_blank' rel="noopener noreferrer">GitHub</a> including the code for <a href="https://github.com/christsantiris/christsantiris" target='_blank' rel="noopener noreferrer">this website</a></p>
